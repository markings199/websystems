...
<html lang="en" dir="ltr">
	...
	<body>
		<header>
			<div class="heading">
				<h1><a href="index.php"><i class="fas fa-angle-double-left"></i></a>		      <img src="logo.png" alt="Your Logo" class="logo"> <span> Admin </span> </h1>
			</div>
			<nav>
				<h3>ORDERS</h3>
				<h3>USERS</h3>
        ...
        echo '<tr id='.$row['id'].'>
            ...
            <td class="delete-btn">
                <form action="admin.php?id='.$row['id'].'" method="post">
                    <button type="submit" name="delete-submit" style="cursor:pointer; border:none; background: transparent; color: #f54c4c; width:100%;">
							...
							<form action="admin.php" method="post" enctype="multipart/form-data">
								...
								<div class="add-mini">
									<div class="add-mini-1">
										...
										<p class="mini">Quantity</p>
										<input class="mini" type="number" name="quantity" min="0" required>
							...
							<form action="admin.php" method="post" enctype="multipart/form-data">
								...
								<div class="update-mini">
									<div class="update-mini-1">
										...
										<input class="mini" type="text" name="price">
										<p class="mini">Quantity</p>
										<input class="mini" type="text" name="quantity">
										<p class="mini">Battery</p>
										<input class="mini" type="text" name="battery">
										<p class="mini">Fuel</p>
										<input class="mini" type="text" name="fuel">
    ...
    <tbody>
        ...
        while($row = $products->fetch_assoc()) {
            echo '<tr id='.$row['id'].'>
                ...
                <td>PHP'.$row["price"].'</td>
                <td>'.$row["type"].'</td>
                <td>'.$row["quantity"].'</td>  <!-- Display Quantity Here -->
                    ...
                    <div class="update-products">
						...
						<div class="add">
							<form action="admin.php" method="post" enctype="multipart/form-data">
								...
								<input type="text" name="email">
								<p>Quantity</p>
								<input type="number" name="quantity" value="" min="1" step="1" required>
